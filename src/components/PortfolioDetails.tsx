...
import { ArrowLeft, Brain, Download, Plus, MoreVertical, FolderPlus, Filter, ArrowUpDown, ArrowUp, ArrowDown } from 'lucide-react';
...
const PortfolioDetails: React.FC = () => {
  ...
  const fetchChartData = async () => {
    ...
    try {
      const performanceData = await getPortfolioPerformance(portfolioId, timeRange);
  ...
  const EmptyState = () => (
    <div className="min-h-[calc(100vh-12rem)] flex items-center justify-center p-4 sm:p-6">
      <div className="text-center max-w-md mx-auto">
        ...
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold mb-4 sm:mb-6">This portfolio is empty</h2>
    ...
    <div className="bg-gray-800/60 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50 hover:border-blue-500/30 transition-all duration-300 hover:shadow-[0_0_20px_rgba(59,130,246,0.1)] group">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs sm:text-sm text-gray-400 truncate">{holding.companyName}</p>
        </div>
        <DropdownMenu.Root>
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4">
        <div className="space-y-3">
          <div>
            ...
            <span className="text-sm sm:text-base font-medium text-white">{holding.quantity}</span>
          </div>
          <div>
            <span className="text-xs text-gray-400 block mb-1">Avg. Buy Price</span>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <div className={`text-sm sm:text-base font-semibold ${
              ...
              <div className="font-mono">{formatCurrency(holding.gainLoss)}</div>
                  ...
                  <div className="xl:hidden">
                    <div className="space-y-4">
                      {sortedHoldings.map((holding) => (
                        <MobileHoldingCard key={holding._id} holding={holding} />
                      ))}
                    </div>
                  </div>
